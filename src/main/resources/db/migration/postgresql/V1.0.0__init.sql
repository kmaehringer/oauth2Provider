...
VALUES
	('web_app', null, '$2a$04$RL2MR1GwRFJITyeTGEm4a.2g9cJ4F3iAcZPEsokimaoa2YlPleXqi', 'FOO', 'implicit,password,authorization_code,refresh_token', null, 'USER,FOO_READ,FOO_WRITE', 36000, 36000, null, true);
...
INSERT INTO t_user_role (username, rolename) VALUES ('reader', 'USER');
INSERT INTO t_user_role (username, rolename) VALUES ('reader', 'FOO_READ');
INSERT INTO t_user_role (username, rolename) VALUES ('writer', 'USER');
